...
import { Paper, Typography, FormGroup, FormControlLabel, FormControl, Button, Select, MenuItem, FormLabel, RadioGroup, Radio, Dialog, DialogTitle, DialogActions, DialogContent, DialogContentText } from '@material-ui/core'
...
export default function BasicInfo(props) {
    ...
    const handleStateChange = event => {
        ...
        if (event.target.value === '') {
            ...
            setState({...state, votingState: event.target.value, stateError: false});
        }
    };
        ...
        <Paper>
            ...
            <FormGroup >
                <FormControl component="fieldset" className={classes.formControl}>
                    ...
                    <RadioGroup aria-label="18+" name="18+" value={state.eighteen} onChange={handleChange("eighteen")}>
                        <FormControlLabel value="yes" control={<Radio />} label="Yes" />
                        <FormControlLabel value="no" control={<Radio />} label="No" />
                    </RadioGroup>
                </FormControl>
                <FormControl className={classes.formControl} error={state.stateError}>
                    <FormLabel id="votingState-label" component="legend">What State do you vote in?</FormLabel>
                    <Select
                        id="votingState"
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    ...
                    <RadioGroup aria-label="eligible" name="eligible" value={state.eligible} onChange={handleChange("eligible")}>
                        <FormControlLabel value="yes" control={<Radio />} label="Yes" />
                        <FormControlLabel value="no" control={<Radio />} label="No" />
                    </RadioGroup>
                </FormControl>
                <FormControl className={classes.formControl} error={state.topError}>
                    <FormLabel id="candidate-label" component="legend">Who is your top candidate?</FormLabel>
                    <Select
                        id="candidate"
